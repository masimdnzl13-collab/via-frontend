...
<div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
  <h2 className="text-lg font-semibold mb-2">📋 Profil Denetimi</h2>
  <p className="text-zinc-400 text-sm mb-4">Profilini analiz et, eksikleri gör.</p>
  <a href="/profil-denetim" className="block w-full bg-zinc-800 hover:bg-zinc-700 py-3 rounded-xl font-semibold transition text-sm text-center">
    Denetle →
  </a>
</div>
<div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
  <h2 className="text-lg font-semibold mb-2">🎯 Performans Tahmini</h2>
  <p className="text-zinc-400 text-sm mb-4">Yayınlamadan önce viral ihtimalini öğren.</p>
  <a href="/performans-tahmin" className="block w-full bg-zinc-800 hover:bg-zinc-700 py-3 rounded-xl font-semibold transition text-sm text-center">
    Tahmin Et →
  </a>
</div>
<div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
  <h2 className="text-lg font-semibold mb-2">👥 Müşteri Analizi</h2>
  <p className="text-zinc-400 text-sm mb-4">Müşterini tanı, doğru kitleye ulaş.</p>
  <a href="/musteri-analizi" className="block w-full bg-zinc-800 hover:bg-zinc-700 py-3 rounded-xl font-semibold transition text-sm text-center">
    Analiz Et →
  </a>
</div>
<div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
...
<div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
  <h2 className="text-lg font-semibold mb-2">🎬 İçerik Serisi</h2>
  <p className="text-zinc-400 text-sm mb-4">İzleyiciyi bağımlı eden dizi planla.</p>
  <a href="/icerik-serisi" className="block w-full bg-zinc-800 hover:bg-zinc-700 py-3 rounded-xl font-semibold transition text-sm text-center">
    Seri Oluştur →
  </a>
</div>
...
<div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
  <h2 className="text-lg font-semibold mb-2">🔍 Algoritma & SEO</h2>
  <p className="text-zinc-400 text-sm mb-4">Algoritmayı yeni, Google'da üst sıraya çık.</p>
  <a href="/algoritma-seo" className="block w-full bg-zinc-800 hover:bg-zinc-700 py-3 rounded-xl font-semibold transition text-sm text-center">
    Analiz Et →
  </a>
</div>
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
