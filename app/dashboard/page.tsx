    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <nav className="flex items-center justify-between px-8 py-4 border-b border-zinc-800">
        ...
        <div className="flex items-center gap-4">
          <span className="text-zinc-400 text-sm">Merhaba, Mustafa 👋</span>
          <div className="w-8 h-8 bg-violet-600 rounded-full flex items-center justify-center text-sm font-bold">M</div>
        </div>
      </nav>
      ...
      <div className="max-w-6xl mx-auto px-8 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-10">
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5">
            <p className="text-zinc-500 text-sm mb-1">Toplam izlenme</p>
            <p className="text-3xl font-bold">12.4K</p>
            <p className="text-green-400 text-sm mt-1">↑ %23 artış</p>
          </div>
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5">
            <p className="text-zinc-500 text-sm mb-1">En iyi içerik</p>
            <p className="text-3xl font-bold">4.2K</p>
            <p className="text-zinc-500 text-sm mt-1">Before/after video</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
              ...
              <div className="space-y-3">
                {[
                  { icon: '🎬', gorev: 'Before/after fade videosu çek', sure: '~10 dk', durum: 'bekliyor' },
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
              ...
              <div className="space-y-2">
                {[
                  { gun: 'Pazartesi', icerik: 'Before/after fade dönüşümü', durum: 'tamamlandi' },
                  { gun: 'Salı', icerik: 'Story anketi — en sevilen saç modeli', durum: 'bekliyor' },
                  { gun: 'Çarşamba', icerik: 'Müşteri yorumu repost', durum: 'bekliyor' },
                  { gun: 'Perşembe', icerik: 'Kampanya postu — hafta içi indirim', durum: 'bekliyor' },
          ...
          <div className="space-y-6">
            <div className="bg-violet-600/10 border border-violet-500/30 rounded-2xl p-6">
              ...
              <p className="text-zinc-400 text-sm mb-4">AI sana özel içerik planı, caption ve hashtag üretsin.</p>
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
              ...
              <div className="space-y-3">
                {[
                  { icerik: 'Fade dönüşüm', izlenme: '4.2K', artis: '+38%' },
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
              ...
              <div className="space-y-2 text-sm text-zinc-400">
                <p>💡 Before/after videoların çok iyi çalışıyor.</p>
